...
and a.anio = {s_anio}
and a.mes = {s_mes}
" name="Report1" pageSizeLimit="100" wizardCaption=" Report1 " wizardLayoutType="Tabular" activeCollection="SQLParameters" parameterTypeListName="ParameterTypeList">
			<Components>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="20" variable="s_anio" parameterType="URL" dataType="Text" parameterSource="s_anio" defaultValue="0" designDefaultValue="2013"/>
				<SQLParameter id="21" variable="s_mes" parameterType="URL" dataType="Integer" parameterSource="s_mes" defaultValue="0" designDefaultValue="3"/>
			</SQLParameters>
			<ReportGroups/>
			<SecurityGroups/>
			<Attributes/>
