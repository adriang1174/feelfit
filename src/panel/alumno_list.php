...
//Class_Initialize Event @11-8C5E1CA5
    function clsGridalumno($RelativePath, & $Parent)
    {
        ...
        $this->activos = & new clsControl(ccsLabel, "activos", "activos", ccsText, "", CCGetRequestParam("activos", ccsGet, NULL), $this);
    }
//End Class_Initialize Event
